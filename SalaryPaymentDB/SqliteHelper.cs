    ...
    public class SqliteHelper
    {
        ...
        {//"Data Source=Test.db3;Pooling=true;FailIfMissing=false";
            get
            {
                ...
                //}
                return "Data Source=test.db;Pooling=true;FailIfMissing=false";
            }
        }
        ...
        public static SQLiteParameter CreateParameter(
            string parameterName, DbType parameterType, object parameterValue)
        {
        ...
        public static DataSet ExecuteDataSet(
            string commandText, params object[] paramList)
        {
        ...
        public static DataSet ExecuteDataSet(
            SQLiteTransaction transaction, string commandText, params SQLiteParameter[] commandParameters)
        {
            if (transaction == null) 
        ...
        /// <remarks>必须手动执行关闭连接transaction.connection.Close</remarks>
        public static DataSet ExecuteDataSet(
            SQLiteTransaction transaction, string commandText, 
        ...
        public static void UpdateDataset(
            SQLiteCommand insertCommand, SQLiteCommand deleteCommand, 
        ...
        public static IDataReader ExecuteReader(
            SQLiteCommand cmd, string commandText, object[] paramList)
        {
        ...
        /// <remarks>Status experimental. Regex appears to be handling most issues. 
        /// Note that parameter object array must be in same 
        /// order as parameter names appear in SQL statement.
        /// </remarks>
        private static SQLiteParameterCollection AttachParameters(
            SQLiteCommand cmd, string commandText, params  object[] paramList)
        {
        ...
        protected internal static void AssignParameterValues(
            IDataParameterCollection commandParameters, DataRow dataRow)
        {
        ...
        /// </exception>
        protected void AssignParameterValues(
            IDataParameter[] commandParameters, params  object[] parameterValues)
        {
            ...
            // Iterate through the IDataParameters, 
            // assigning the values from the corresponding position in the 
            // value array
            for (int i = 0, j = commandParameters.Length, k = 0; i < j; i++)
            {
                if (commandParameters[i].Direction != 
                    ParameterDirection.ReturnValue)
                {
                    // If the current array value derives from IDataParameter, 
